...
const NotFoundPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors">
      ...
      <button
        className="px-6 py-3 rounded-lg bg-blue-600 dark:bg-blue-500 text-white font-semibold shadow hover:bg-blue-700 dark:hover:bg-blue-400 transition-colors"
        onClick={() => navigate('/')}
      >
        홈으로 돌아가기
      </button>
